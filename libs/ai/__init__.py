...
class SegmentAnythingModelVitB(SegmentAnythingModel):
    ...
    def __init__(self):
        super().__init__(
            ...
            # ),
            encoder_path='sam/weights/sam_vit_b_01ec64.quantized.encoder.onnx',
            decoder_path='sam/weights/sam_vit_b_01ec64.quantized.decoder.onnx'
        )
...
class SegmentAnythingModelVitL(SegmentAnythingModel):
    ...
    def __init__(self):
        super().__init__(
            ...
            # ),
            encoder_path='sam/weights/sam_vit_l_0b3195.quantized.encoder.onnx',
            decoder_path='sam/weights/sam_vit_l_0b3195.quantized.decoder.onnx'
        )
...
class SegmentAnythingModelVitH(SegmentAnythingModel):
    ...
    def __init__(self):
        super().__init__(
            ...
            # ),
            encoder_path='sam/weights/sam_vit_h_4b8939.quantized.encoder.onnx',
            decoder_path='sam/weights/sam_vit_h_4b8939.quantized.decoder.onnx'
        )
...
class EfficientSamVitT(EfficientSam):
    ...
    def __init__(self):
        super().__init__(
            ...
            # ),
            encoder_path='sam/weights/efficient_sam_vitt_encoder.onnx',
            decoder_path='sam/weights/efficient_sam_vitt_decoder.onnx'
        )
...
class EfficientSamVitS(EfficientSam):
    ...
    def __init__(self):
        super().__init__(
            ...
            # ),
            encoder_path='sam/weights/efficient_sam_vits_encoder.onnx',
            decoder_path='sam/weights/efficient_sam_vits_decoder.onnx'
        )
